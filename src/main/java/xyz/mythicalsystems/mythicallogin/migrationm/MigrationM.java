package xyz.mythicalsystems.mythicallogin.migrationm;
...
import xyz.mythicalsystems.mythicallogin.migrationm.api.InputStreamProvider;
...
public class MigrationM {
     ...
     */
    public void loadMigrations(String folder, @SuppressWarnings("rawtypes") Class mainClass) {
        long time = System.currentTimeMillis();
