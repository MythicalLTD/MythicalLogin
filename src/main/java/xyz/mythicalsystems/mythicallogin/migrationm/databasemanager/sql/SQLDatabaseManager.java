package xyz.mythicalsystems.mythicallogin.migrationm.databasemanager.sql;

import javax.sql.DataSource;

import xyz.mythicalsystems.mythicallogin.migrationm.api.DatabaseManager;
import xyz.mythicalsystems.mythicallogin.migrationm.api.Migration;
import xyz.mythicalsystems.mythicallogin.migrationm.api.exceptions.MigrationException;
...
public class SQLDatabaseManager implements DatabaseManager {
    ...
    public void executeMigration(ProgramInfo info, Migration migration) throws MigrationException {
        ...
        try (Scanner scanner = new Scanner(migration.getInputStream())) {
